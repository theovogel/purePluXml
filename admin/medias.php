...
<p id="medias_back" style="display:none"><a class="pure-button" href="javascript:void(0)" onclick="toggle_divs();return false"><?php echo L_MEDIAS_BACK ?></a></p>
			...
			<div class="options1">
				...
				<ul>
					...
					<li>
						...
						&nbsp;&nbsp;(<a class="pure-button" href="parametres_affichage.php"><?php echo L_MEDIAS_MODIFY ?>)</a>
					</li>
					<li>
...
<div id="files_manager">
	<form action="medias.php" method="post" id="form_medias" class="pure-form form_medias">
		<div class="manager">
			<div class="create">
		...
		<div class="files">
			...
			<tr>
				...
				<th class="image">&nbsp;</th>
				<th><a class="pure-button pure-button-primary" href="javascript:void(0)" class="hcolumn" onclick="document.forms[1].sort.value='<?php echo $sort_title ?>';document.forms[1].submit();return true;"><?php echo L_MEDIAS_FILENAME ?></a></th>
				...
				<th class="date"><a class="pure-button pure-button-primary" href="javascript:void(0)" class="hcolumn" onclick="document.forms[1].sort.value='<?php echo $sort_date ?>';document.forms[1].submit();return true;"><?php echo L_MEDIAS_DATE ?></a></th>
			</tr>
			</thead>
			<tbody>
			<?php
			...
			if($plxMedias->aFiles) {
				foreach($plxMedias->aFiles as $v) { # Pour chaque fichier
					...
					echo '<td class="icon"><a class="pure-button" onclick="this.target=\'_blank\';return true;" title="'.plxUtils::strCheck($v['name']).'" href="'.$v['path'].'"><img alt="" src="'.$v['.thumb'].'" class="thumb" /></a></td>';
					echo '<td>';
			...
			<p>
				<?php plxUtils::printSelect('selection[]', $selectionList , '', false, '', false) ?>
				<input class="submit" type="submit" name="btn_action" value="<?php echo L_OK ?>" />
