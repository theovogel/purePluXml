...
<p><a class="pure-button" href="parametres_users.php"><?php echo L_USER_BACK_TO_PAGE ?></a></p>
...
<form class="pure-form" action="user.php" method="post" id="form_user">
	<fieldset class="pure-control-group">
		<?php plxUtils::printInput('id', $id, 'hidden');?>
		<p class="field"><label for="id_lang"><?php echo L_USER_LANG ?>&nbsp;:</label>
		<?php plxUtils::printSelect('lang', plxUtils::getLangs(), $plxAdmin->aUsers[$id]['lang']) ?></p>
		<p class="field"><label for="id_email"><?php echo L_USER_MAIL ?>&nbsp;:</label>
		<?php plxUtils::printInput('email', plxUtils::strCheck($plxAdmin->aUsers[$id]['email']), 'text', '30-255') ?></p>
