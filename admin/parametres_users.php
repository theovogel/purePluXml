...
<form class="pure-form" action="parametres_users.php" method="post" id="form_users">
	<table class="pure-table" class="table">
	<thead>
		<tr>
	...
	if($plxAdmin->aUsers) {
		foreach($plxAdmin->aUsers as $_userid => $_user)	{
			if (!$_user['delete']) {
				...
				echo '</td>';
				echo '<td><a class="pure-button" href="user.php?p='.$_userid.'">'.L_OPTIONS.'</a></td>';
				echo '</tr>';
			}
		}
